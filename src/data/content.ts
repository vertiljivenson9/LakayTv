...
export const contents: Content[] = [
  {
    id: "1",
    title: "Kafou",
    description: "Doc et Zoe sont embauchés pour livrer un colis mystérieux à travers Port-au-Prince. À un carrefour, ils rencontrent un chien et leur destin bascule. Un thriller haïtien qui explore les croyances vodou et la réalité sociale d'Haïti avec une maîtrise cinématographique exceptionnelle. Le film a été sélectionné dans de nombreux festivals internationaux.",
    thumbnail: "/images/kafou.jpg",
    youtubeId: "2DvwkKkubL0",
    year: 2017,
    category: "movie",
    genre: "Thriller",
    duration: "1h 45min",
  ...
  },
  {
    ...
    thumbnail: "/images/freda.jpg",
    youtubeId: "LeMQdVSInsQ",
    year: 2021,
    category: "movie",
    genre: "Drame",
    duration: "1h 38min",
  ...
  },
  {
    ...
    thumbnail: "/images/kidnapping.jpg",
  ...
  },
  {
    ...
    thumbnail: "/images/iloveyouanne.jpg",
    youtubeId: "wvVJLfxzb4w",
    year: 2003,
    category: "movie",
  ...
  },
  {
    id: "5",
    title: "Ensansib",
    description: "Une tragique histoire de couple qui explore les défis de la vie conjugale en Haïti. Ce film poignant aborde les thèmes de la jalousie, de la trahison et de la rédemption avec une sensibilité rare. Une production de Magic Film écrite et réalisée par Steeve Bicot.",
    thumbnail: "/images/kafou.jpg",
  ...
  },
  {
    ...
    description: "Une série haïtienne captivante qui suit les vies entrelacées de plusieurs familles à Port-au-Prince. Secrets de famille, trahisons et rédemptions se mêlent dans ce feuilleton qui a conquis le public haïtien. Une production de qualité qui montre l'évolution du cinéma haïtien.",
    thumbnail: "/images/freda.jpg",
    youtubeId: "QmaMVIu1MwU",
    year: 2024,
    category: "series",
    genre: "Drame",
  ...
  },
  {
    ...
    description: "Une histoire inspirante sur le pouvoir de la foi dans la vie d'une famille haïtienne confrontée à des épreuves difficiles. Ce film touchant explore les thèmes de la spiritualité, de l'espoir et de la résilience qui sont au cœur de la culture haïtienne.",
    thumbnail: "/images/iloveyouanne.jpg",
  ...
  },
  {
    ...
    description: "Plongez dans l'univers vibrant du Carnaval haïtien, l'une des fêtes les plus colorées et énergiques des Caraïbes. Musique, danse, costumes et traditions se mêlent dans cette célébration unique de la culture haïtienne qui attire des milliers de visiteurs chaque année.",
    thumbnail: "/images/carnaval.jpg",
